    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            <a href="index.html" class="navbar-brand ms-4 ms-lg-0">
                <h1 class="display-5 text-primary m-0">Magister</h1>
            </a>
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto p-4 p-lg-0">
                    ...
                    <a href="{{ route('buildings.index') }}" class="nav-item nav-link">Edificios</a>
                    <a href="{{ route('employees.index') }}" class="nav-item nav-link">Empleados</a>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Proyectos</a>
                        <div class="dropdown-menu border-light m-0">
                            <a href="{{ route('projects.index')}}" class="dropdown-item">Proyecto</a>
                            <a href="{{ route('projectchiefs.index') }}" class="dropdown-item">Jefe de proyecto</a>
                            <a href="{{ route('teams.index') }}" class="dropdown-item">Equipo</a>
                            <a href="{{ route('clientcompanies.index') }}" class="dropdown-item">Cliente</a>
                        </div>
                    </div>
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">Unidades</a>
                        <div class="dropdown-menu border-light m-0">
                            <a href="{{ route('units.index') }}" class="dropdown-item">Unidades</a>
                            <a href="{{ route('responsibleunits.index') }}" class="dropdown-item">Jefe de unidad</a>
                    </div>
                </div>
                            ...
                            <div class="row justify-content-start">
                                <div class="col-lg-8">
                                    <p
                                       ...
                                       Bienvenido a</p>
                                    <h1 class="display-1 mb-4 animated slideInDown">Servicios informaticos Magister
                                    </h1>
                                    <a href="/" class="btn btn-primary py-3 px-5 animated slideInDown">Ver mas</a>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row justify-content-start">
                                <div class="col-lg-7">
                                    <p
                                        class="d-inline-block border border-white rounded text-primary fw-semi-bold py-1 px-3 animated slideInDown">
                                        Magister</p>
                                    <h1 class="display-1 mb-4 animated slideInDown">Desarrollo de aplicaciones</h1>
                                    <a href="/" class="btn btn-primary py-3 px-5 animated slideInDown">Ver mas</a>
                                </div>
                            </div>
                        </div>
