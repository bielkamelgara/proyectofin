    ...
    <div class="container-fluid fixed-top px-0 wow fadeIn" data-wow-delay="0.1s">
        ...
        <nav class="navbar navbar-expand-lg navbar-light py-lg-0 px-lg-5 wow fadeIn" data-wow-delay="0.1s">
            ...
            <div class="d-none d-lg-flex ms-1">
                <a class="btn btn-light btn-sm-square rounded- ms-3" href="{{ route('login')}}">
                    <small class="fab fa- -f text-primary">Iniciar sesion</small>
                </a>
                <a class="btn btn-light btn-sm-square rounded- ms-3" href="{{route('register')}}">
                    <small class="fab fa- text-primary">Registrarse</small>
                </a>
            </div>
        </nav>
    </div>
